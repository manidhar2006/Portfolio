...
const Sidebar = () => {
  ...
  const socialLinks = [
    ...
    { icon: Youtube, url: "https://youtube.com/@johndoe", label: "YouTube" },
  ];
  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-80 bg-card border-r border-border shadow-lg z-50 overflow-y-auto">
      <div className="p-8 space-y-8">
        ...
        <div className="pt-4">
          <button className="w-full bg-primary text-primary-foreground py-3 px-4 rounded-lg font-medium hover:bg-primary/90 transition-colors shadow-lg">
            Download Resume
          </button>
        </div>
      </div>
